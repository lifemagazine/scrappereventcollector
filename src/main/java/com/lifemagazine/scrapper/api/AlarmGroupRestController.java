...
import com.lifemagazine.scrapper.service.AlarmGroupService;

@RestController
@RequestMapping("api/alarmgroup")
public class AlarmGroupRestController {
	...
	AlarmGroup getAlarmGroup(@PathVariable Integer id) {
